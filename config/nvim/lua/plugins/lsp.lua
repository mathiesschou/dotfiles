    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd("LspAttach", {
        callback = function(ev)
          ...
          -- Diagnostic keymaps
          vim.keymap.set("n", "<leader>dn", vim.diagnostic.goto_next, vim.tbl_extend("force", opts, { desc = "Next diagnostic" }))
          vim.keymap.set("n", "<leader>dp", vim.diagnostic.goto_prev, vim.tbl_extend("force", opts, { desc = "Previous diagnostic" }))
